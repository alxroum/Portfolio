...
import { grabProjectData } from "../App";
    ...
    return (
        ...
        <div id="intro">
            ...
            <div id="projects-grid">
                {
                grabProjectData().map(({title, icon, desc, stack, links}) => (
                    <ProjectCard key={title} title={title} icon={icon} desc={desc} stack={stack} links={links}/>
                ))
                }
            </div>
            </section>
            ...
            <section id="other">
            <p className="label reveal">Hobbies</p>
            <h2 className="reveal">Other Interests.</h2>
            </section>
